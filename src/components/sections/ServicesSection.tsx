...
export const ServicesSection = () => {
  ...
  return (
    <section 
      ref={ref}
      id="services" 
      className={`relative min-h-screen flex items-center justify-center py-12 px-8 transition-all duration-700 ${isVisible ? 'animate-zoom-in' : 'opacity-0'}`}
    >
      <div className="max-w-7xl mx-auto w-full grid md:grid-cols-[300px_1fr] gap-12 items-center">
