...
export const VideosSection = () => {
  ...
  return <section className="relative min-h-screen flex items-center py-12 px-4 md:px-8">
      <div className="max-w-7xl grid grid-cols-1 md:grid-cols-[30%_70%] gap-12 items-center w-full mx-auto">
        {/* Coluna 1 - Texto */}
        <div className="space-y-6 mx-[35px]">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogTrigger asChild>
            <div ref={imageRef} className="cursor-pointer transition-transform duration-300 hover:scale-105">
              <img src={isInView ? "https://cardeal.tv/wp-content/uploads/2025/07/tela2-3.png" : "https://cardeal.tv/wp-content/uploads/2025/07/tela1-3.png"} alt="Veja todos os vídeos" className="w-full h-auto transition-opacity duration-500" />
            </div>
          </DialogTrigger>
