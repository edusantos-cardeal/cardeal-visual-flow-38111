...
export const GallerySection = () => {
  ...
  return <section ref={ref} id="gallery" className={`relative min-h-screen flex flex-col items-center justify-center py-20 px-8 transition-all duration-700 ${isVisible ? 'animate-zoom-in' : 'opacity-0'}`}>
