...
export const EnergySection = () => {
  ...
  return (
    <section 
      ref={ref} 
      id="energy" 
      className={`relative min-h-[80vh] md:min-h-screen flex flex-col items-center justify-center py-8 md:py-12 px-4 md:px-8 transition-all duration-700 ${isVisible ? 'animate-zoom-in' : 'opacity-0'}`}
    >
